#!/usr/bin/env python3
"""
测试任务_1772562098 - Todo 管理器核心功能验证
验证 Todo 管理器的所有核心功能
"""
...
class TestTaskCreation(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备：创建干净的测试环境"""
        self.test_file = "test_1772562098.json"
...
class TestTaskListing(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_list_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestTaskCompletion(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_done_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestTaskDeletion(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_delete_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestTagManagement(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_tags_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestPriorityManagement(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_priority_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestStatistics(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_stats_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestExport(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_export_1772562098.json"
        self.csv_file = "test_export_1772562098.csv"
        self.md_file = "test_export_1772562098.md"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestCLIBackwardCompatibility(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_compat_1772562098.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestCLICommands(unittest.TestCase):
    ...
    def test_cli_add(self):
        """测试 CLI 添加任务"""
        test_file = "test_cli_add_1772562098.json"
    ...
    def test_cli_stats(self):
        """测试 CLI 统计命令"""
        test_file = "test_cli_stats_1772562098.json"
        if os.path.exists(test_file):
            os.remove(test_file)
        try:
