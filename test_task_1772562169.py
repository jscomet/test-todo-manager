#!/usr/bin/env python3
"""
测试任务_1772562169 - Todo 管理器核心功能验证
验证 Todo 管理器的所有核心功能
"""
...
class TestTaskCreation(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备：创建干净的测试环境"""
        self.test_file = "test_1772562169.json"
...
class TestTaskListing(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_list_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestTaskCompletion(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_done_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestTaskDeletion(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_delete_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestTagManagement(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_tags_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestPriorityManagement(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_priority_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestStatistics(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_stats_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestExport(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_export_1772562169.json"
        self.csv_file = "test_export_1772562169.csv"
        self.md_file = "test_export_1772562169.md"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestCLIBackwardCompatibility(unittest.TestCase):
    ...
    def setUp(self):
        """测试前准备"""
        self.test_file = "test_compat_1772562169.json"
        todo.TASKS_FILE = self.test_file
        if os.path.exists(self.test_file):
            os.remove(self.test_file)
...
class TestCLICommands(unittest.TestCase):
    ...
    def run_cli(self, args, test_file=None):
        """运行 CLI 命令"""
        env = {**os.environ, "PYTHONPATH": os.getcwd()}
        if test_file:
            env["TASKS_FILE"] = test_file
    ...
    def test_cli_add(self):
        """测试 CLI 添加任务"""
        test_file = "test_cli_add_1772562169.json"
        if os.path.exists(test_file):
            os.remove(test_file)
        try:
            result = self.run_cli(["add", "CLI 测试任务"], test_file)
            self.assertEqual(result.returncode, 0)
            self.assertIn("CLI 测试任务", result.stdout)
        finally:
            if os.path.exists(test_file):
                os.remove(test_file)
    ...
    def test_cli_help(self):
        ...
        self.assertEqual(result.returncode, 0)
        self.assertIn("Simple Todo Manager", result.stdout)

    def test_cli_stats(self):
        """测试 CLI 统计命令"""
        test_file = "test_cli_stats_1772562169.json"
        if os.path.exists(test_file):
            os.remove(test_file)
        try:
            todo.TASKS_FILE = test_file
            todo.add_task("CLI 统计任务", "高")
            result = self.run_cli(["stats"], test_file)
            self.assertEqual(result.returncode, 0)
